...
namespace RepositoryPatternDemoDone.Models
{
    public partial class RepositoryPatternDemoDoneDBContext : DbContext
    {
        public RepositoryPatternDemoDoneDBContext()
        {
        }

        public RepositoryPatternDemoDoneDBContext(DbContextOptions<RepositoryPatternDemoDoneDBContext> options)
            : base(options)
        {
        }
